...
export function Card({ title, description, linkText, linkHref, children }: CardProps) {
  ...
  return (
    <div className="relative">
      ...
      {/* Main Card Container */}
      <div className="dark:border-white/20 border-black/50 relative bg-transparent rounded-3xl shadow-lg hover:shadow-2xl py-12 md:py-20 px-8 group hover:cursor-pointer transition-all duration-500 ease-in-out translate-y-0 hover:-translate-y-2 overflow-hidden border" onClick={handleClick}>
