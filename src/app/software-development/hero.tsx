...
import { softwareDevelopmentHeroSupportingCopy } from "@/lib/value-propositions"
        ...
        <div className="mx-auto lg:grid lg:items-center lg:gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col text-center lg:text-left w-full">
            <p className="mb-2 text-muted-light dark:text-muted-dark tracking-widest font-normal">
              {location ? `${location.toUpperCase()} | ` : ""}SOFTWARE DEVELOPMENT
            </p>
            ...
            <p className="mb-8 text-basetext-muted-foreground md:text-lg mx-auto lg:mx-0 max-w-2xl lg:max-w-xl relative z-10 leading-relaxed">
              ...
              {softwareDevelopmentHeroSupportingCopy}
            </p>
