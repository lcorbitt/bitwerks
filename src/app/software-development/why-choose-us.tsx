import { Boxes, Braces, Gauge, MessageCircle, Smartphone } from "lucide-react"
import Image from "next/image"

import { Heading2 } from "@/components/ui/heading"
import { softwareDevelopmentWhyChooseBlocks } from "@/lib/value-propositions"

const whyChooseIcons = [
  <Boxes key="0" className="h-8 w-8 text-brand" strokeWidth={1.5} aria-hidden />,
  <MessageCircle key="1" className="h-8 w-8 text-brand" strokeWidth={1.5} aria-hidden />,
  <Braces key="2" className="h-8 w-8 text-brand" strokeWidth={1.5} aria-hidden />,
      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="space-y-8">
            {softwareDevelopmentWhyChooseBlocks.map((item, index) => (
