      ...
      <div className="container pt-0">
        <div className="mx-auto max-w-4xl text-center mb-16">
          ...
          <p className="text-xl text-muted-light dark:text-muted-dark">
            We provide expert web design & development services, focusing on the details of each project and delivering highly optimized custom solutions that combine beautiful design with powerful functionality.
          </p>
        </div>
